 ...
 {function name="categories" nodes=[] depth=0}
  ...
  <div class="block-categories">
    <ul class="category-top-menu">
      <li><a class="text-uppercase h6" href="$blogCategories.link nofilter}">{$blogCategories.name}</a></li>
      {if !empty($blogCategories.children)}
        <li>{categories nodes=$blogCategories.children}</li>
      {/if}
    </ul>
  </div>*
  *}